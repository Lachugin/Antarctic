...
/* harmony import */ var _modules_modals_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modals/menu */ "./js/modules/modals/menu.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals_scroll__WEBPACK_IMPORTED_MODULE_2__["scroll"])();
  Object(_modules_modals_menu__WEBPACK_IMPORTED_MODULE_3__["getMenu"])(); // Modules
  // ---------------------------------
...
var getMenu = function getMenu() {
  var headerNav = document.querySelector('[data-nav]');
  var headerLogo = document.querySelector('[data-logo]');
  var headerList = document.querySelector('[data-nav-list]');
  var headerBtn = document.querySelector('[data-btn]');
  var headerBody = document.querySelector('[data-body]');
  var headerItems = document.querySelectorAll('[data-item]');
  var headerOverplay = document.querySelector('[data-overplay]');
...
var scroll = function scroll() {
  var smoothLinks = document.querySelectorAll('.nav__item a[href^="#"]');
